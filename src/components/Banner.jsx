            ...
            <section id="about" class="text-gray-600 body-font">
                <div class="container mx-auto flex px-5 pt-36 pb-16 md:flex-row flex-col items-center">
                    <div class="lg:flex-grow md:w-1/2 lg:pl-20 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <p class="mb-8 leading-relaxed font-medium dark:text-gray-300">A dedicated and versatile Full Stack Developer with over 2 years of experience, I specialize in designing, developing, and deploying robust web applications. My expertise spans both front-end and back-end technologies, including HTML, CSS, Bootstrap, Tailwind CSS, JavaScript, React, Node.js, Python, Django, Php, Laravel and databases such as MySql , SqlLite and SQL. <br /> I am adept at collaborating with cross-functional teams to deliver high-quality, user-centric solutions that drive business success.<br/></p>
