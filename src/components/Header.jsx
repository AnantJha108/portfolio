                    ...
                    <div className='w-full bg-gray-100 dark:bg-gray-800'>
                        <nav className="">
                            ...
                            <ul className="lg:hidden flex flex-col items-center justify-center ">
                                ...
                                <a  target='_blank' onClick={()=>setIsMenuOpen(!isMenuOpen)} href='https://github.com/AnantJha108' class="hover:text-gray-900 dark:text-gray-300 cursor-pointer font-medium hover:bg-gray-600 w-full py-2 px-4">GitHub Profile
                                </a>
                            </ul>
                        </nav>
                    </div>
